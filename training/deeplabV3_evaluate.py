...
def main():
    ...
    model_state_dict = torch.load(parent_dir/ "checkpoint" / "DeepLabV3" / "epoch_34.pth")
    ...
    result_file = new_dir/ "DeepLabV3_CrossEntropyLoss_Seg_Loss_Results.png"
    ...
    plt.ylabel("Score")
    plt.title("DeepLabV3 Segmentation Performance Metrics")
    ...
    print(f"Loss: {avg_loss}, Accuracy: {avg_acc} mIoU: {avg_IOU}, Dice: {avg_DICE}")
